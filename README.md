...
### Create Dockerfiles
The first step to containerizing a pipeline stage with docker is to develop the application, create a dockerfile accordingly and push it to GitHub. This step is supposed to be the only maual step in our final deployment, and the rest will evetually be automated. But we will show all the steps manully this time to give you a beter under stadning of docker.
