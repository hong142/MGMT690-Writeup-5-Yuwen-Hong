...
Following the similar step we did for validation stage, we can docker;ize each stage of our pipeline and run it on some machine without installing a bunch of codes and ependencies.
